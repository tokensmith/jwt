...
SecureTokenBuilder secureTokenBuilder = appFactory.secureTokenBuilder(Algorithm.RS256, keyPair);

Claim claim = new Claim();
claim.setUriIsRoot(true);

Token token = secureTokenBuilder.build(Algorithm.RS256, claim);
